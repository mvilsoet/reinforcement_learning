...
def hyperparameters():
	...
	parser.add_argument('--epsilon', type=float, default=.8, help='exploration parameter')
	parser.add_argument('--gamma', type=float, default=.9, help='discount reward factor. represents how confident a '
